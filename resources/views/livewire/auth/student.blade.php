                        ...
                        <div class="rowbox">
                            ...
                            <div class="IdNo">
                                <div class="form-group fullname">
                                    <label for="fullname">Student ID No.</label>
                                    <input type="text" id="fullname" placeholder="ex. 2024-72045">
                                  </div>
                            </div>
                            <div class="password">
                            ...
                            <div class="box">
                                <div class="form-group gender">
                                    ...
                                    <select id="gender">
                                      ...
                                      <option value="Male">BSCS</option>
                                      <option value="Female">BSIT</option>
                                      <option value="Other">BSIS</option>
                                      <option value="Other">BSLIS</option>
                                    </select>
                                  </div>
                            </div>
                        </div>
